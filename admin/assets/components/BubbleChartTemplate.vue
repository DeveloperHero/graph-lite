<template>
	<div class="bubbleChart gl_chart_template" id="bubble">
								...
								<template v-for="(data, PIndex) in dataset.data">
									<div class="gl_bb_point">
										<div class="button_input_fields">
											...
											<p class="gl_fieldRequiredError" v-if="data.ifxPointEmpty || data.ifyPointEmpty || data.ifrPointEmpty">Field required</p>
										</div>
										<div v-if="PIndex != 0">
		...
		<div class="graphDiv">
			<img src="./../../images/bubble.gif" class="gifImg" v-if="showGif">
