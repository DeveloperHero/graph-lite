...
class Graph_Lite_Admin {
	...
	public function enqueue_assets() {
		...
		wp_enqueue_style( 'sweet_modal', plugin_dir_url( __FILE__ ) . 'css/jquery.sweet-modal.min', array(), $this->version );
		...
		wp_enqueue_script( 'sweet_modal', plugin_dir_url( __FILE__ ) . 'js/jquery.sweet-modal.min.js', array( 'jquery' ), $this->version, true );
